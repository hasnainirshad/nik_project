...
def PreActResNet164_pruned(num_classes=10):
    model = ResNet(PreActBottleneck, layers=[18] * 3, filters=[16, 32, 64],
                  num_classes=num_classes)
...
def PreActResNet56_pruned(num_classes=10):
    model = ResNet(PreActBlock, layers=[9] * 3, filters=[16, 32, 64],
                  num_classes=num_classes)
