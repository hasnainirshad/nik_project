...
from svp.imagenet.train import create_model_and_optimizer, unprune_model_and_optimizer, _LabelSmoothing
...
def active(run_dir: str = './run',
           ...
           datasets_dir: str = '/drive2/data', dataset: str = 'imagenet',
           augmentation: bool = True,
           validation: int = 0, shuffle: bool = True,


           arch: str = 'resnet50', optimizer: str = 'sgd',
        ...
        #    initial_subset: int = 2_000,
        #    rounds: Tuple[int, ...] = (8_000, 10_000, 10_000, 10_000, 10_000),
           initial_subset: int = 25_623,
           rounds: Tuple[int, ...] = (102_493, 128_117, 128_117, 128_117, 128_117),
